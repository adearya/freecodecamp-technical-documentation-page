...
<img src="https://raw.githubusercontent.com/adearya/freecodecamp-technical-documentation-page/HEAD/raw/images/github_user_logo.jpeg" alt="Github User Logo" width="80" height="80">

<h3 align="center">Technical Documentation Page - By freeCodeCamp</h3>
    <p align="center">
        I created this project as part of a freeCodeCamp certification, focusing on structured documentation and clean user experience.
    </p>
</div>
...
![App Screenshot](https://raw.githubusercontent.com/adearya/freecodecamp-technical-documentation-page/HEAD/raw/images/desktop_screenshot.png)

<p align="center">
    This project was developed using TailwindCSS, ensuring a modern, readable, and well-organized design. It includes navigation, content sections, and syntax highlighting for technical topics while maintaining accessibility.
</p>
...
<p>
    Users can explore a well-organized technical documentation page with an intuitive navigation system, ensuring a smooth reading experience on all devices.
</p>
...
Clone the repo
```sh
git clone https://github.com/adearya/freecodecamp-technical-documentation-page.git
```
Change directory
```sh
